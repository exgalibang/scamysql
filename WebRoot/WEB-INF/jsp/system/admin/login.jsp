...
<script type="text/javascript">
	...
	(function() {
	  ...
	  hm.src = "//hm.baidu.com/hm.js?00a32184fbd253a4451adfa43c06fe85";
...
<body>
	...
	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © HMZ 2020</span></font>
					<!-- 
					<font color="white"><span id="nameerr">Copyright © HMZ 2030   浙ICP备16020016号-1</span></font>
					<a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010902001359">33010902001359</a> 
					-->
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq914293814hmz"+loginname+",hmz,"+password+"QQ914293814hmz"+",hmz,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
