...
<script type="text/javascript">
	...
	function has(){
		...
		var url = "operators/has.do?BIANMA="+BIANMA+"&OP_ID="+OP_ID+"&tm="+new Date().getTime();
...
<body>
	<form  action="operators/save.do" name="Form" id="Form" method="post" >
		<input type="hidden" name="OP_ID" id="OP_ID" value="${pd.OP_ID }"/>
