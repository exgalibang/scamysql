			...
			<div class="widget-body">
			 ...
			 <div class="widget-main">
					...
					<div class="step-content row-fluid position-relative">
						...
						<label style="float:left;padding-left: 35px;"><input name="apikey" id="form-field-radio1" type="radio" value="icon-edit" checked="checked" ><span class="lbl">apikey:</span></label>
						<label style="float:left;padding-left: 5px;margin-top: -5px;"><input name="apikey" id="apikey" style="width:200px;" type="text" value="" title="请求外部地址服务需要的apikey"></label>
						
					</div>
					<div class="step-content row-fluid position-relative">
						<div style="float: left;">
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址" value="<%=basePath%>appuser/getAppuserByUm.do?USERNAME=hmz1" style="width:540px;">
