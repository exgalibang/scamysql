...
function sendSever(){
	...
	var apikey = $("#apikey").val();	//请求外部地址需要的apikey
	...
	$.ajax({
    	...
    	data: {serverUrl:$("#serverUrl").val()+"&FKEY="+$.md5(paraname+nowtime+',fh,'),requestMethod:$("#S_TYPE").val(),apikey:apikey,tm:new Date().getTime()},
		dataType:'json',
		cache: false,
