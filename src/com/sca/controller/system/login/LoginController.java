package com.sca.controller.system.login;
...
import com.sca.entity.system.Menu;
import com.sca.entity.system.Role;
import com.sca.entity.system.User;
import com.sca.service.system.menu.MenuService;
import com.sca.service.system.role.RoleService;
import com.sca.service.system.user.UserService;
import com.sca.util.AppUtil;
import com.sca.util.Const;
import com.sca.util.DateUtil;
import com.sca.util.PageData;
import com.sca.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq914293814hmz", "").replaceAll("QQ914293814hmz", "").split(",hmz,");
